<footer class="d-flex flex-wrap justify-content-between align-items-center py-4 mt-4 border-top navbar navbar-expand-lg bg-light">
    <div class="col-md-4 d-flex align-items-center">
        ...
        <span class="mb-3 mb-md-0 text-muted">© 2022 || Ô_Toulouse, Perrine_LVB Inc</span>
    </div>

    <ul class="me-5 nav col-md-4 justify-content-end list-unstyled d-flex">
        <li class="ms-3"><a class="text-muted" href="https://twitter.com/Toulouse" target="_blank"><svg class="bi" width="24" height="24">
